<template>
	<div id="homePageSection" class="paddingFromMenu" v-if="showGames">
		...
		<div id="gameCoversSection" class="flex-row flex-wrap flex-align-center paddingFromMenu">
			<GameCover class="gameBlock gameCoverCard" v-for="game in sortedGames" :key="game.GameID" :game="game" />
		</div>
	</div>
	<div v-else>
		<h2>
...
<script setup lang="ts">
	...
	import GameCover from "@views/game/_GameCover.vue";
	...
	import MagnifyingGlassIcon from "@icons/FontAwesome/MagnifyingGlassIcon.vue";
