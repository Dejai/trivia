<template>
	<div id="gamePageContainer" class="flex-row flex-wrap flex-justify-left flex-align-start flex-gap-30">
		<div
			...
			class="gamePagePadding flex-column flex-gap-10 flex-justify-left flex-align-start leftMenuWidth">
			...
			<div id="navTabs" class="flex-gap-5 flex-justify-left flex-align-start">
				...
				<p v-if="isGameAdmin" class="tab section showOnLogin" @click="onSwitchTab('qna')" :class="{ selected: showQnATab }">
					Questions/Answers
				</p>
...
<script setup lang="ts">
	...
	import OverviewView from "@views/game/_OverviewView.vue";
	import QuestionsAnswersView from "@views/game/QuestionsAnswersView.vue";
	import MediaView from "@views/game/MediaView.vue";
	import ArchiveView from "@views/game/ArchiveView.vue";
	import IconButton from "@views/IconButton.vue";
	import CircleUserIcon from "@icons/FontAwesome/CircleUserIcon.vue";
