<template>
	<main>
		<FormContainer>
			...
			<SessionSetting v-for="setting in props.session?.Settings" :setting="setting" :session="props.session" :rules="rules" />
			<FormActions>
				<div>
...
<script setup lang="ts">
	...
	import SessionSetting from "@views/game/SessionSetting.vue";
	import FormContainer from "@views/forms/FormContainer.vue";
	import FormRow from "@views/forms/FormRow.vue";
	import FormActions from "@views/forms/FormActions.vue";
