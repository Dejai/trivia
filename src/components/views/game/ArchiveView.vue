...
<script setup lang="ts">
	...
	import CircleChevronDown from "@icons/FontAwesome/CircleChevronDownIcon.vue";
	import CircleChevronRight from "@icons/FontAwesome/CircleChevronRightIcon.vue";
