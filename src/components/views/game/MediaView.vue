<template>
	<div>
		<h3 class="italic" style="padding-bottom: 1%" v-if="showMediaForm">NOTE: Only JPEG and MP3 files are allowed</h3>
		...
		<div id="gameMediaSection">
			<Image v-for="image in images" :key="image.Name" :url="image.Url" :label="image.DisplayName" :is-preview="true" />
			<Audio
...
<script setup lang="ts">
	...
	import MediaForm from "@views/game/MediaForm.vue";
