<template>
	<div>
		<div class="center_section_702" style="padding-top: 1%">
			<div>
				<p>
					Run a test of the game to ensure everything works as expected.
					<span style="color: orange">This should not be used for the real game.</span>
				</p>
...
<script setup lang="ts">
	...
	var gameID = route?.params?.gameID as string;
</script>
