<template>
	<main>
		<div
			...
			class="pointer questionCell"
			:class="{ tiltingCell: isShowSelectable, cellViewed: props.pair._prevOpen }"
			@click="openCell">
			{{ cellValue }}
		</div>
...
<script setup lang="ts">
	...
	import WhoGotItRight from "@views/jeopardy/WhoGotItRight.vue";
	import Image from "@views/media/Image.vue";
	import Audio from "@views/media/Audio.vue";
	import TimerCountdownView from "@views/TimerCountdownView.vue";
	import SpinnerIcon from "@icons/FontAwesome/SpinnerIcon.vue";
	import IconButton from "@views/IconButton.vue";
	import EyeIcon from "@icons/FontAwesome/EyeIcon.vue";
	import XMarkIcon from "@icons/FontAwesome/XMarkIcon.vue";
	import PlusIcon from "@icons/FontAwesome/PlusIcon.vue";
	import RotateIcon from "@icons/FontAwesome/RotateIcon.vue";
...
<style scoped>
	...
	#teamAnswerList.onlyOneRight .whoGotItRight:not(.isRightAnswerBlock) {
		color: red;
		display: none;
	}
